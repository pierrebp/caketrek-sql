<div class="tracks index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('difficulty_level'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($track['Track']['start_date']); ?>&nbsp;</td>
		<td><?php echo h($track['Track']['end_date']); ?>&nbsp;</td>
		<td><?php echo h($track['Track']['distance']); ?>&nbsp;</td>
		<td><?php echo h($track['Track']['difficulty_level']); ?>&nbsp;</td>
		<td>
